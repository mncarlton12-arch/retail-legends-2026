...
window.SEN_CONFIG = {
  ...
  ecommerceExpo: {
    ...
    executivesConfirmed: [
      ...
      { name: null, title: "Head of North America", company: "G-STAR RAW",
        status: "Confirmed", image: null, imageAlt: "SEN placeholder avatar — Head of North America, G-STAR RAW", link: null,
        source: "BB roster: Confirmed · name TBD · placeholder avatar" },
