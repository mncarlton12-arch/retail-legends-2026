# Executive headshot provenance

Researched July 8, 2026 from credible public sources only (official sites,
company press rooms, event speaker pages). Audit trail for every image in this
folder. Unnamed delegation seats use the SEN-branded placeholder avatar
...
| `neha-kovach.jpg` | Neha Kovach — Global Head of CRM, Data, CX & Loyalty, David Yurman | digitalmarketing-conference.com (#DMWF North America speaker page, 1024×1024) | Good — cross-checked vs Deloitte Digital + Coresight event pages; photo appears professionally retouched |

Notes:
- Title variants exist for Neha Kovach and Vijay Talwar — see TODO comments in
  `shared/config.js`; confirm preferred wording with each executive before wide
  distribution.
- Replace any image at the same filename to update the site; keep this table
  current when you do.
